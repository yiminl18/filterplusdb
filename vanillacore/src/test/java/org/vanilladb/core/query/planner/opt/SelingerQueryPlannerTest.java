...
public class SelingerQueryPlannerTest {
	private static Logger logger = Logger
			.getLogger(SelingerQueryPlannerTest.class.getName());
	...
	public static void init() {
		...
		if (logger.isLoggable(Level.INFO))
			logger.info("BEGIN SELINGER QUERY PLANNER TEST");
	}
	
	@AfterClass
	public static void finish() {
		if (logger.isLoggable(Level.INFO))
			logger.info("FINISH SELINGER QUERY PLANNER TEST");
	}
	...
	public void testQuery() {
		...
		Plan p = new SelingerLikeQueryPlanner().createPlan(qd, tx);
		Schema sch = p.schema();
		assertTrue(
				"*****SelingerQueryPlannerTest: bad selinger plan schema",
		...
		while (s.next())
			assertEquals(
					"*****SelingerPlannerTest: bad selinger plan selection",
	...
	public void testJoinQuery() {
		...
		s.beforeFirst();
		while (s.next())
			assertTrue("*****SelingerQueryPlannerTest: bad selinger plan schema",
